...
echo gsutil cp $TMP_RELEASE_DIR/$RPMFILE1 gs://$GS_URL/opnfv-$RPMFILE1
gsutil cp $TMP_RELEASE_DIR/$RPMFILE1 gs://$GS_URL/opnfv-$RPMFILE1
...
echo "------------------------------------------------------"
echo "Done!"
echo "Artifact is available as http://$GS_URL/opnfv-$RPMFILE1"
